...
TEXT["accuse2"]   =
  "Still insistent that you didn't do it? [newline] Fine. Who did then? #accuse"
...
TEXT["a_amelia_scandal"] = ["Tennis","I don't care"]
  TEXT["amelia_scandal_1"] = "After the tennis ball scandal she was put under house arrest for the next three days, my stash was taken on her second day in custody."
...
TEXT["a_bill_evidence"] = ["Resume","Article","Certificate"]
  ...
  TEXT["bill_evidence_3"] = "He lost Good Dog of the Year [newline] But he felt terrible afterwards and promised he'd never do it again. Bill is the kind of dog to keep a promise like that."
...
which would mean you’ve probably learned a thing or two about buried bones. And your close friends with Bill, who sullied my grandfather’s good name."
...
TEXT["a_scraggly_evidence"] = ["Bone","Letter","Map"]
  ...
  TEXT["scraggly_evidence_2"] = "Scraggly and my Grandpa used to be good friends. I don't see how that makes him guilty. If anything it should clear is name because he and my grandpa were close friends. Besides Scraggly has a ton of stashes all over town, why would he steal from mine?"
...
TEXT["a_scraggly_bone"] = ["Desk","Boxes","PC"]
  TEXT["scraggly_bone_1"] = "That was the one bone from my stash that wasn't stolen. #scraggly_bitemark"
  TEXT["scraggly_bone_2"] = "You mean the bone you can't even click on? Yeah, I'm sure that one's really critical to the story."
  TEXT["scraggly_bone_3"] = "There is no bone by the PC. Were you even paying attention? Or are you just brute forcing the dialogue tree trying to find the answer? If so, stop it! The people behind this game worked really hard on it."
...
TEXT["a_scraggly_maps"] = ["Public","Private"]
  TEXT["scraggly_maps_1"] = "My grandpa and Scraggly used to hunt for treasure together. Scraggly only made maps to his treasure though, my grandpa never did, he'd just remember and was almost never \
wrong. #scraggly_wrong"


  TEXT["scraggly_maps_2"] = "All of his maps are hand made by him. He only keeps the really important ones in his private collection. Last week I found out that one of his private collection maps was a map to my stash! #scraggly_why"
...
TEXT["a_holly_evidence"] = ["Scarf","Receipt","Award"]
  ...
  TEXT["holly_evidence_2"] = "The receipt does place her within a few blocks of the crime scene. But that's not substantial enough. Lots of people eat at that restaurant."
...
TEXT["a_holly_award"] = ["Samples","Excavation"]
